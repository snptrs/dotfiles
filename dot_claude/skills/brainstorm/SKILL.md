...
8. **Suggest the user reviews and edits the spec, then runs `/write-plan` or says "plan it" when ready**
...
digraph brainstorming {
    ...
    "Ready for /write-plan" [shape=doublecircle];
    ...
    "User reviews spec?" -> "Ready for /write-plan" [label="approved"];
}
```
...
Suggest `/write-plan` when the user is ready, after reviewing the spec.
