...
deps.now(function()
  ...
  map_vis('vla', 'add_label()', 'Add label')
  map_vis('vlr', 'remove_label()', 'Remove label')
  map_vis('vl,', 'select_label()', 'Select label (cwd)')
  map_vis('va', 'add_label("core")', 'Add to core')
  map_vis('vr', 'remove_label("core")', 'Remove from core')
  map_vis('v,', 'select_path(nil, { filter = "core" })', 'Select core (cwd)')
end)
